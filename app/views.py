...
def patient_book_appointment_view(request):
    ...
    message=None
    mydict={'appointmentForm':appointmentForm,'message':message}
    if request.method=='POST':
        ...
        if appointmentForm.is_valid():
            ...
            if doctor.department == 'Cardiologist':
                if 'heart' in desc:
                    ...
                    return render(request,'patient_book_appointment.html',{'appointmentForm':appointmentForm,'message':message})
...
def patient_appointment_view(request):
    patient=models.Patient.objects.get(user_id=request.user.id) #for profile 
